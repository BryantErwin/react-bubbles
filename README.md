...
A token is used for authentication purposes on web servers for secured logins 
- [ ] What steps can you take in your web apps to keep your data secure?
By Implementing Client Side Authentication using the url request and coding it in there to “authorize”
- [ ] Describe how web servers work.
Web servers work by sending request to the server for the source code.
